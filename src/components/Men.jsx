...
export default function Men(){
    ...
    function HandleBag(e){
        ...
        var bagListArr = JSON.parse.bagList
        const item = e.target.value
        bagListArr.push(e.target.getAttribute("params"))
        localStorage.setItem('productUrl',(e.target.getAttribute("params")))
        localStorage.setItem('bagList',JSON.stringify(bagListArr))
        console.log("bg",bagListArr)
